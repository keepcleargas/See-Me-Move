...
public class AccelerometerHandler {
    ...
    private static SeeMeMoveHandler listener;
     ...
     */
    public static void startToListen(SeeMeMoveHandler accelerometerListener) {
        sensorManager = (SensorManager) SeeMeMoveActivity.getContext().getSystemService(Context.SENSOR_SERVICE);
        List<Sensor> sensors = sensorManager.getSensorList(Sensor.TYPE_ACCELEROMETER);
        if (sensors.size() > 0) {
     ...
     */
    public static void startListening(SeeMeMoveHandler accelerometerListener, int threshold, int interval) {
